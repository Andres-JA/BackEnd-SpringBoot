...
import org.springframework.security.crypto.password.PasswordEncoder; // CAMBIO: Importar la interfaz
...
public class UserService {
    ...
    private final PasswordEncoder passwordEncoder; // CAMBIO: Usar la interfaz PasswordEncoder
